...
class WeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post weights_url, params: { weight: { animal_id: @weight.animal_id, date: @weight.date, note: @weight.note, weight: @weight.weight } }
    end
  ...
  test "should update weight" do
    patch weight_url(@weight), params: { weight: { animal_id: @weight.animal_id, date: @weight.date, note: @weight.note, weight: @weight.weight } }
