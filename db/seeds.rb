...
animal1 = Animal.create(animal_number:1, species: "bovino", birthday: "2017-1-1", ranch: 'sauces', status: 'engorde', lot_id: 1)
animal2 = Animal.create(animal_number:2, species: "bovino", birthday: "2017-1-2", ranch: 'sauces', status: 'engorde',lot_id: 1)
Weight.create(animal_id: 1, weight: 300, date: '2017-01-01')
Weight.create(animal_id: 1, weight: 320, date: '2017-01-21')
Weight.create(animal_id: 2, weight: 300, date: '2017-01-01')
Weight.create(animal_id: 2, weight: 320, date: '2017-01-21')

animal3 = Animal.create(animal_number:1, species: "ovino", birthday: "2017-1-1", ranch: 'sauces', status: 'engorde', lot_id: 2)
animal4 = Animal.create(animal_number:2, species: "ovino", birthday: "2017-1-2", ranch: 'sauces', status: 'engorde', lot_id: 2)
Weight.create(animal_id: 3, weight: 30, date: '2017-01-01')
Weight.create(animal_id: 3, weight: 32, date: '2017-01-21')
Weight.create(animal_id: 4, weight: 30, date: '2017-01-01')
Weight.create(animal_id: 4, weight: 32, date: '2017-01-21')

animal1 = Animal.create(animal_number:5, species: "bovino", birthday: "2017-1-1", ranch: 'laureles' , status: 'engorde', lot_id: 1)
animal2 = Animal.create(animal_number:6, species: "bovino", birthday: "2017-1-2", ranch: 'laureles', status: 'engorde', lot_id: 1)
Weight.create(animal_id: 5, weight: 300, date: '2017-01-01')
Weight.create(animal_id: 5, weight: 320, date: '2017-01-21')
Weight.create(animal_id: 6, weight: 300, date: '2017-01-01')
Weight.create(animal_id: 6, weight: 320, date: '2017-01-21')

lot1 = Lot.create(ranch: 'sauces', species: 'bovino', number: '1', name:"Lote de prueba 1")
lot1 = Lot.create(ranch: 'sauces', species: 'ovino', number: '2', name:"Lote de prueba 2")
...
plot4 = Plot.create(number:1, area: 20, ranch:"laureles", plot_type: "bovino", boundaries: "{lat: 15.484526, lng: -86.409336}, {lat:15.483420, lng: -86.408842}, {lat:15.483152, lng: -86.407779}, {lat:15.483669, lng: -86.405410}, {lat:15.487005, lng:-86.405706}")
plot4 = Plot.create(number:2, area: 20, ranch:"laureles", plot_type: "ovino", boundaries: "{lat: 15.484526, lng: -86.409336}, {lat:15.483420, lng: -86.408842}, {lat:15.483152, lng: -86.407779}, {lat:15.483669, lng: -86.405410}, {lat:15.487005, lng:-86.405706}")
...
PlotEvaluation.create(plot_id: 5, date: '2017-12-1', water_score: 4, pasture_score: 4, fences_score: 5)
